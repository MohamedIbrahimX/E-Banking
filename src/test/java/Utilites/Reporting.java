...
public class Reporting extends TestListenerAdapter {
    ...
    public void onStart(ITestContext context) {
        ...
        sparkReporter.config().setDocumentTitle("SeleniumE-BankingReport"); //Title of report

        sparkReporter.config().setReportName("E-Banking"); //Name of the report
        ...
        extentReports.setSystemInfo("user","mohamed");
    }
